...
@if (Auth::guard('user')->check() && Auth::guard('user')->user()->hasRole('User'))
  @section('title', 'Child')
  @section('page-name', 'Index Child')
  @section('main-page', 'Child')
@else
  @section('title', 'Users')
                ...
                <tbody>
                  ...
                  @foreach ($users as $user)
                    <tr>
                      ...
                      <td><span class="badge bg-info">{{ $user->profession->name ?? 'No Profession' }}</span>
                      </td>
                      ...
                      <td>
                        <div class="btn-group">
                          <a href="{{ route('users.edit', $user->id) }}" type="button" class="btn btn-info"><i
                              class="fas fa-edit"></i></a>
                          <a href="#" class="btn btn-danger" onclick="performDestroy({{ $user->id }}, this)"><i

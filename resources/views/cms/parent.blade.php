...
<head>
    ...
    <title>MASAREEFI | @yield('title')</title>
      ...
      <div class="input-group input-group-sm">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{route('cms.dashboard')}}" class="brand-link">
                ...
                <span class="brand-text font-weight-light">MASAREEFI </span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; {{ now()->year }} <a href="#">MASAREEFI </a>.</strong> All rights
            reserved.
        </footer>

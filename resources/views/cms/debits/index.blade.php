                ...
                <tbody>
                  ...
                  @foreach ($debits as $debit)
                    <tr>
                      ...
                      <td>{{ $debit->created_at ? $debit->created_at->format('Y-m-d') : '-' }}</td>
                      <td>{{ $debit->updated_at ? $debit->updated_at->format('Y-m-d') : '-' }}</td>
                      <td>
                        <div class="btn-group">
                          <a href="{{ route('debits.edit', $debit->id) }}" type="button" class="btn btn-info"><i
                              class="fas fa-edit"></i></a>
                          <a href="#" class="btn btn-danger" onclick="performDestroy({{ $debit->id }}, this)"><i
